...
```
mlops-stacks-ivy-demo        <- Root directory. Both monorepo and polyrepo are supported.
│
├── mlops_stacks_ivy_demo       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
...
the [project README](./mlops_stacks_ivy_demo/README.md).
...
After that, follow the [ML pull request guide](docs/ml-pull-request.md)
 and [ML resource config guide](mlops_stacks_ivy_demo/resources/README.md)  to propose, test, and deploy changes to production ML code (e.g. update model parameters)
or pipeline resources (e.g. use a larger instance type for model training) via pull request.

| Role                          | Goal                                                                         | Docs                                                                                                                                                                |
|-------------------------------|------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Data Scientist                | Get started writing ML code for a brand new project                          | [project README](./mlops_stacks_ivy_demo/README.md) |
...
| Data Scientist                | Modify production model ML resources, e.g. model training or inference jobs  | [ML resource config guide](mlops_stacks_ivy_demo/resources/README.md)  |
...
need to run it again for project `mlops-stacks-ivy-demo`.
