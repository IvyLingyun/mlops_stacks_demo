...
# ``mlops_stacks_ivy_demo/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops-stacks-ivy-demo-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.mlops_stacks_ivy_demo.mlops-stacks-ivy-demo-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_stacks_ivy_demo.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_stacks_ivy_demo.trip_dropoff_features",
