...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``mlops_stacks_ivy_demo/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in mlops-stacks-ivy-demo/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in mlops-stacks-ivy-demo/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-mlops-stacks-ivy-demo-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.mlops_stacks_ivy_demo.mlops-stacks-ivy-demo-model", "Full (Three-Level) Model Name")
