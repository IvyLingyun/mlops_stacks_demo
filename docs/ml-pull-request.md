...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-stacks-ivy-demo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/staging/mlops-stacks-ivy-demo/mlops-stacks-ivy-demo-model)
* [Prod model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/prod/mlops-stacks-ivy-demo/mlops-stacks-ivy-demo-model)
. 
